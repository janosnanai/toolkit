...
// ReadJSON tries to read the body of a request and converts from json into go data variable
func (t *Tools) ReadJSON(w http.ResponseWriter, r *http.Request, data interface{}) error {
	maxBytes := 1024 * 1024 // 1 meg
	if t.MaxJSONSize != 0 {
	...
	if err != nil {
		...
		case errors.Is(err, io.EOF):
			{
				return errors.New("bdody must not be empty")
			}
